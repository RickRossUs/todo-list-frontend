...
{/* <marquee behavior="smooth" direction="top" sx={{overflow:'hidden'}}>
  <Box component="img" src={img1} alt="Foto-1" sx={{width:'50%', height:"70vh", borderRaduis:5}}></Box>  
  <Box component="img" src={img2} alt="Foto-2" sx={{width:'50%', height:"70vh", borderRaduis:5}}></Box>  
  <Box component="img" src={img3} alt="Foto-3" sx={{width:'50%', height:"70vh", borderRaduis:5}}></Box>  
  <Box component="img" src={img4} alt="Foto-4" sx={{width:'50%', height:"70vh", borderRaduis:5}}></Box>  
  <Box component="img" src={img5} alt="Foto-5" sx={{width:'50%', height:"70vh", borderRaduis:5}}></Box>  
</marquee> */}
